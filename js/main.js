...
//Keep track of the mouse position, so we can make the ketupat move
...
function animate() {
    ...
    //Make the ketupat move
    if (object && objToRender === "second_ketupat") {
...
//add mouse position listener, so we can make the ketupat move
